      ...
      switch (settings.SidebarType) {
        ...
        case "full":
          ...
          $(".sidebartoggler").on("click", function () {
            ...
            $(".sidebartoggler i").toggleClass("");
            $(".fullsidebar svg").addClass("text-dark");
          });
           
          $(".fullsidebar").on("click", function () {
            $("#main-wrapper").attr("data-sidebartype", "full");
            $(".fullsidebar svg").removeClass("text-dark");
            $(".fullsidebar svg").addClass("text-primary");
            $(".sidebartoggler svg").removeClass("text-primary");
          });
          break;
